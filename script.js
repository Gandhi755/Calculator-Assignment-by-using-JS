...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#aa6600";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#aa6600";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#aa6600";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#aa6600";
    }
}
...
function keyPressed(e) {
    ...
    if (isNumber || operators.includes(e.key) || e.key == "Enter" || e.key == dotPress || 
        ...
        if (e.key == "Enter"){
            ...
            document.getElementById("backspace_btn").style.backgroundColor  = "#2b2b2b";
            backspace_remove()
        }
        else if (commaPress){
            button_number(dot)
...
function keyReleased(e){
    e.preventDefault()
    if (e.key == "Backspace"){
        document.getElementById("backspace_btn").style.backgroundColor  = "#181818";
    }
}